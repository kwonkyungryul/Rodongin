                ...
                <form action="/employee/join" method="post">
                    ...
                    <div class="mb-1">
                        ...
                        <div class="">
                            ...
                            <div class="d-flex">
                                <input class="form-control" type="text" placeholder="주소입력"
                                    aria-label="default input example" name="employeeAddress1" value="${address}">
                                <button type="button" onclick="execPostCode();" class="btn btn-primary ms-1"
                                    style="width: 20%;">주소찾기</button>
                            </div>
        ...
        function execPostCode() {
            new daum.Postcode({
                ...
                //    $("[name=addr1]").val(data.zonecode);
                   $("[name=employeeAddress1]").val(fullRoadAddr);
