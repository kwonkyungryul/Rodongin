  ...
  <%@ include file="../layout/header.jsp" %>
    ...
    <form id="profileForm">
        ...
        <div class="d-flex justify-content-between my_info_update_margin">
          <div>
            ...
            <div class="mb-2 d-flex align-items-center">
              ...
              <input class="form-control my_info_update_input" name="employeePassword" type="password" value="${empInfo.employeePassword}"
                id="employeePassword" />
            </div>
            <div class="mb-2 d-flex align-items-center">
              <span class="my_info_update_span">이메일</span>
              <input class="form-control my_info_update_input" name="employeeEmail" type="email" value="${empInfo.employeeEmail}"
                id="employeeEmail" />
            </div>
            <div class="mb-2 d-flex align-items-center">
              <span class="my_info_update_span">생년월일</span>
              <input class="form-control my_info_update_input" name="employeeBirth" type="date" value="${empInfo.employeeBirth}"
                id="employeeBirth" />
            </div>
            <div class="mb-2 d-flex align-items-center">
              <span class="my_info_update_span">연락처</span>
              <input class="form-control my_info_update_input" name="employeeTel" type="text" value="${empInfo.employeeTel}"
                id="employeeTel" />
            </div>
            <div class="d-flex align-items-center">
              <span class="my_info_update_span">주소</span>
              <input class="form-control my_info_update_input" name="employeeAddress" type="text" value="${empInfo.employeeAddress}"
                id="employeeAddress" />
            </div>
          </div>
          <div class="d-flex align-items-center">
            <div class="my_info_thumbnail me-4">
              ...
              <input type="file" class="card-img-top" id="profile" name="profile" value="${empInfo.employeeThumbnail}" onchange="chooseImage(this)">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="button_center">
        <button onclick="updateById(${empInfo.id})" class="main_blue_btn" type="button">수정</button>
      </div>
    </form>
