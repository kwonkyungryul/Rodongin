                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <div class="d-flex">
                            ...
                            <div class="m-2">
                                <div class="mb-3">
                                    <span class="m-1" style="font-weight: bold; font-size: 20px;">권경렬</span>
                                </div>
                                <div class="d-flex mb-1">
                                    <span class="m-1" style="font-weight: bolder;">지역 </span>
                                    <span class="m-1">| 울산광역시 > 울주군 | </span>
                    ...
                    <div class="ms-5 m-4 align-items-center" style="width: 130px;">
                        ...
                        <div>
                            <a href="" class="my_main_yellow_btn" type="submit">Button</a>
                        </div>
                    </div>
                </div>
            </div>
