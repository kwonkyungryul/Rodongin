...
values
('왜이렇게 연락이 안되나요?', '1번째 내용1번째 내용1번째 내용1번째 내용1번째 내용1번째 내용1번째 내용1번째 내용', 1, now()),
('회원가입이 안됩니다.', '2번째 내용2번째 내용2번째 내용2번째 내용2번째 내용2번째 내용2번째 내용2번째 내용', 1, now()),
('기업에 이력서 지원하기는 어떻게 하나요?', '3번째 내용3번째 내용3번째 내용3번째 내용3번째 내용3번째 내용3번째 내용3번째 내용', 2, now()),
('이력서 리스트가 제대로 안보이네요', '4번째 내용4번째 내용4번째 내용4번째 내용4번째 내용4번째 내용4번째 내용4번째 내용', 2, now()),
('공고조회를 하려는데요!?', '5번째 내용5번째 내용5번째 내용5번째 내용5번째 내용5번째 내용5번째 내용5번째 내용', 3, now()),
('개인정보 수정은 어디서 하나요?', '6번째 내용6번째 내용6번째 내용6번째 내용6번째 내용6번째 내용6번째 내용6번째 내용', 4, now()),
('스펙 매칭은 어떻게 하나요?', '7번째 내용7번째 내용7번째 내용7번째 내용7번째 내용7번째 내용7번째 내용7번째 내용', 4, now()),
('이력서는 몇개까지 등록 가능한가요?', '8번째 내용8번째 내용8번째 내용8번째 내용8번째 내용8번째 내용8번째 내용8번째 내용', 5, now()),
('비밀번호를 잊어버렸어요!', '9번째 내용9번째 내용9번째 내용9번째 내용9번째 내용9번째 내용9번째 내용9번째 내용', 6, now()),
('검색이 안되네요..', '10번째 내용10번째 내용10번째 내용10번째 내용10번째 내용10번째 내용10번째 내용', 7, now()),
('로동인 항상 잘쓰고 있습니다', '11번째 내용11번째 내용11번째 내용11번째 내용11번째 내용11번째 내용11번째 내용', 8, now()),
('불편한 부분을 개선해주세요', '12번째 내용12번째 내용12번째 내용12번째 내용12번째 내용12번째 내용12번째 내용', 9, now()),
('홈페이지 디자인이 멋져요!', '13번째 제목13번째 제목13번째 제목13번째 제목13번째 제목13번째 제목13번째 제목', 9, now()),
('로동인 덕분에 대기업에 취업했어요~!', '14번째 제목14번째 제목14번째 제목14번째 제목14번째 제목14번째 제목14번째 제목', 10, now()),
('불편사항이 바로바로 개선되어 아주 좋습니다.', '15번째 제목15번째 제목15번째 제목15번째 제목15번째 제목15번째 제목15번째 제목', 10, now());
