...
public @ResponseBody ResponseEntity<?> update(@PathVariable int id,
        @RequestBody AnnouncementUpdateReqDto announcementUpdateReqDto, HttpServletResponse response){
            ...
            if (announcementUpdateReqDto.getAnnouncementTitle() == null || announcementUpdateReqDto.getAnnouncementTitle().isEmpty()) {
                throw new CustomApiException("title을 작성해주세요");
            }
            if (announcementUpdateReqDto.getAnnouncementContent() == null || announcementUpdateReqDto.getAnnouncementTitle().isEmpty()) {
                throw new CustomApiException("Content을 작성해주세요");
            }
            if (announcementUpdateReqDto.getAnnouncementCarrer() == null || announcementUpdateReqDto.getAnnouncementTitle().isEmpty()) {
                throw new CustomApiException("Carrer을 작성해주세요");
            }
            if (announcementUpdateReqDto.getAnnouncementHireType() == null || announcementUpdateReqDto.getAnnouncementTitle().isEmpty()) {
                throw new CustomApiException("HireType을 작성해주세요");
            }
            if (announcementUpdateReqDto.getAnnouncementSalary() == null || announcementUpdateReqDto.getAnnouncementTitle().isEmpty()) {
                throw new CustomApiException("Salary을 작성해주세요");
            }
            if (announcementUpdateReqDto.getAnnouncementArea() == null || announcementUpdateReqDto.getAnnouncementTitle().isEmpty()) {
