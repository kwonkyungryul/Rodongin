...
public class AnnouncementController {
    ...
    public @ResponseBody ResponseEntity<?> update(@PathVariable int id,
        ...
        announcementService.게시글수정(id, announcementUpdateReqDto, comPrincipal.getId());
    ...
    public String updateForm(@PathVariable int id, Model model) {
        ...
        if (announcementPS.getId() != comPrincipal.getId()) {
    ...
    public @ResponseBody ResponseEntity<?> saveForm(@RequestBody AnnouncementSaveReqDto AnnouncementSaveReqDto) {
        ...
        if (AnnouncementSaveReqDto.getStackId() == null
            ...
            throw new CustomApiException("기술스택을 선택해주세요");
        }
