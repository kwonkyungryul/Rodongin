...
public class CompanyService {
    ...
    @Transactional
    public void 기업소개등록(CompanyDetailResDto companyDetailResDto, int comPrincipalId ){
        ...
        int result = companyRepository.updateById(
            comPrincipalId,
            companyDetailResDto.getCompanyFullname(),
            companyDetailResDto.getCompanyThumbnail(),
            companyDetailResDto.getCompanyEstablish(),
            companyDetailResDto.getCompanySales(),
            companyDetailResDto.getCompanyEmployeesNumber(),
            companyDetailResDto.getCompanyIntroduction(),
            companyDetailResDto.getCompanyHistory(),
            companyDetailResDto.getCompanyVision()
        );
        if (result != 1) {
