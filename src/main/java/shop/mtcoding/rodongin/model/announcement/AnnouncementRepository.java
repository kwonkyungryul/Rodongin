...
public interface AnnouncementRepository {
    public int findAnnouncementCount(@Param("searchOpt") String searchOpt, @Param("skills") List<String> skills, @Param("content") String content);

    public AnnouncementDetailRespDto findAnnouncementAndCompanyId(int id);

    public List<AnnouncementDetailRespDto> findAnnouncementlist(@Param("searchOpt") String searchOpt, @Param("skills") List<String> skills, @Param("content") String content, @Param("start") int start, @Param("end") int end);
